...
const INPUT_FILE = join(__dirname, '../test-data/Default2019_v2.ssf');
const OUTPUT_FILE = join(__dirname, '../test-data/Default2019_v2.output.ssf');

describe('Parser Round-Trip V2: output must match input exactly', () => {
...
// ──────────────────────────────────────────────────────────────────────────────
describe('Parser Round-Trip V2: edge cases', () => {
