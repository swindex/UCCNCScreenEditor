...
<div class="list">
  <div class="item" [foreach]="this.filteredItems as item" [selected]="this.selectedItem && item.value == this.selectedItem.value" data-cy="onItemClicked" onclick="this.onItemClicked(item)">
