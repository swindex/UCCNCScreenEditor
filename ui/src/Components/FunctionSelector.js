  ...
  constructor(){
    ...
    this.template = `<div class="fieldrow">
      <input type="text" bind="this.displayValue" [attribute]="this.attributes" disabled autocomplete="off" onchange = "this.onChange($event)" />
			<div class="icon" style="color: white; background-color: #2196f3; padding: 3px 5px; height: auto; cursor: pointer; border-radius: 2px;" data-cy="onIconClick" onclick="this.onIconClick()"><i class="fas fa-search"></i></div>
    </div>`
